    ...
    <style type="text/css">
        ...
        */
        ...
        button.es-button {
            ...
            mso-padding-alt: 0;
            mso-border-alt: 10px solid #00413f;
        }
                    ...
                    <tr>
                        <td class="esd-stripe" align="center" bgcolor="#1b142d" style="background-color: #1b142d;">
                            <table bgcolor="transparent" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600" style="background-color: transparent;">
                                <tbody>
                                <tr>
                                    <td class="esd-structure es-p20t es-p15b es-p10r es-p10l" align="left">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="esd-block-text es-p5b">
                                                                <h1 style="color: #00413f;">${holidayName} SALE</h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="esd-block-text es-p5b">
                                                                <h2 style="color: #00413f;">UP TO ${percent} OFF</h2>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" class="esd-block-button es-p15t es-p10b">
                    ...
                    <tr>
                        <td class="esd-stripe" align="center" bgcolor="#1b142d" style="background-color: #1b142d;">
                            <table bgcolor="#ffffff" class="es-footer-body" align="center" cellpadding="0" cellspacing="0" width="600">
                                <tbody>
                                <tr>
                                    <td class="esd-structure es-p10t es-p10b es-p20r es-p20l" align="left" esd-custom-block-id="73050" bgcolor="transparent" style="background-position: center top; background-color: transparent;">
                                                    ...
                                                    <table style="background-position: center top;" width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-c es-p15t es-p10b" align="left">
                                                                <p style="font-size: 12px; line-height: 150%;">Vector graphics designed by <a target="_blank" href="http://www.freepik.com/">Freepik</a>.</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-social es-p5t es-p5b es-m-txt-c" align="right" style="font-size:0">
                                                                <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td class="es-p10r" valign="top" align="center"><a target="_blank" href="https://"><img title="Facebook" src="https://tlr.stripocdn.email/content/assets/img/social-icons/logo-white/facebook-logo-white.png" alt="Fb" width="32"></a></td>
                                                                        <td class="es-p10r" valign="top" align="center"><a target="_blank" href="https://"><img title="Twitter" src="https://tlr.stripocdn.email/content/assets/img/social-icons/logo-white/twitter-logo-white.png" alt="Tw" width="32"></a></td>
                                                                        <td class="es-p10r" valign="top" align="center"><a target="_blank" href="https://"><img title="Instagram" src="https://tlr.stripocdn.email/content/assets/img/social-icons/logo-white/instagram-logo-white.png" alt="Inst" width="32"></a></td>
                                                                        <td valign="top" align="center"><a target="_blank" href="https://"><img title="Youtube" src="https://tlr.stripocdn.email/content/assets/img/social-icons/logo-white/youtube-logo-white.png" alt="Yt" width="32"></a></td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
                                ...
                                <tr>
                                    <td class="esd-structure es-p15t es-p10b es-p20r es-p20l" align="left" esd-general-paddings-checked="true" bgcolor="transparent" style="background-color: transparent;">
                                        <!--[if mso]><table width="560" cellpadding="0" cellspacing="0"><tr><td width="270" valign="top"><![endif]-->
                                        <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                            <tbody>
                                            <tr>
                                                <td class="es-m-p20b esd-container-frame" width="270" align="left">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td align="left" class="esd-block-text es-m-txt-c"><a target="_blank" href class="unsubscribe">Unsubscribe</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
